...
if __name__ == "__main__":
    ...
    ax[0,0].scatter(pts1[:,1], pts1[:,2], c=pred_colors1, s=0.6, marker='.', facecolors=pred_colors)
    ax[0,1].scatter(pts1[:,1], pts1[:,2], c=norm_pca_features, s=0.6, marker='.', facecolors=norm_pca_features)
    
    ax[1,0].scatter(pts1[:,1], pts1[:,2], c=pred_colors1, s=0.6, marker='.', facecolors='r')
    ax[1,1].scatter(pts2[:,1], pts2[:,2], c=pred_colors2, s=0.6, marker='.', facecolors='r')

    
    ax[0,0].axis('equal'), ax[0,1].axis('equal'), ax[1,0].axis('equal'), ax[1,1].axis('equal')
